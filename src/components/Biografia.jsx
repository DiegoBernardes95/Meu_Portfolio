        ...
        <div className={style.fullBio}>
            ...
            <a name='Sobre'></a>
                <div className={style.textBio}>
                    <h1 className='sectionTitle'>Como tudo começou</h1>
                    <p className='pScroll'><strong>Comecei minha história no desenvolvimento web em setembro de 2022, através do projeto Programadores Cariocas, da Prefeitura do Rio em parceria com o Resilia Educação e Senac RJ.</strong></p>
                    <p className='pScroll'><strong>Desde então estudo as principais tecnologias presentes no mercado, tanto em back-end quanto em front-end.</strong></p>
                    <p className='pScroll'><strong>Tenho me empenhado para dar início a minha carreira dentro dessa área que aprendi a amar. Quero trabalhar no desenvolvimento de aplicações que auxiliem no cotidiano do máximo de usuários possíveis.</strong></p>
                </div>
                <div className={style.imgBio}>
                    <div className='imgScrollBio'>
                        <img src={PC} alt="pc" />
                    </div>
                </div>    
            </div>
